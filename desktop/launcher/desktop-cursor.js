    ...
    document.addEventListener('mouseover', function (e) {
      ...
      if (t.closest('.light-again-modal')) {
        ...
        if (t.closest('button')) {
          ...
          // Game-over panel: the Steve toggle, Big-text toggle, Disable-flashes toggle + name input are non-button clickables
          stopPoll(); halo.classList.remove('cursor-halo--game');
          if (t.closest('#_la-go-steve-wrap') || t.closest('#_la-go-bigtext-wrap') || t.closest('#_la-go-noflash-wrap') || t.closest('#_la-go-name'))
            halo.classList.add('cursor-halo--hover');
          else halo.classList.remove('cursor-halo--hover');
