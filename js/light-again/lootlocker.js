...
(function () {
  ...
  LA.laGoT = function (key) {
    var FB_FR = {
      ...
      laModeUnlockHint: 'Élimine ces ennemis pour débloquer le mode Hardcore', laEnemyScout: 'Éclaireurs', laEnemyShooter: 'Tireurs', laEnemyBruiser: 'Mastodontes', laGoReplayPrompt: 'Rejouer en', laModeResume: 'Reprendre', laSpeed: 'Vitesse',
    };
    var FB_EN = {
      ...
      laModeUnlockHint: 'Eliminate these enemies to unlock Hardcore mode', laEnemyScout: 'Scouts', laEnemyShooter: 'Shooters', laEnemyBruiser: 'Bruisers', laGoReplayPrompt: 'Play again in', laModeResume: 'Resume', laSpeed: 'Speed',
    };
    var lang = 'fr';
    try {
