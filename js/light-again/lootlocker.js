...
(function () {
  ...
  LA.laGoT = function (key) {
    var FB_FR = {
      ...
      laGoSubmit: 'Soumettre', laGoSubmitted: 'Envoyé !', laGoNewRecord: 'Nouveau record !', laGoNewBadge: 'Record !',
      laGoThisRun: 'Cette partie', laGoRecords: 'Records', laGoComboShort: 'Combo', laGoKillsShort: 'Ennemis',
      ...
      laModeUnlockHint: 'Élimine ces ennemis pour débloquer le mode Hardcore', laEnemyScout: 'Éclaireurs', laEnemyShooter: 'Tireurs', laEnemyBruiser: 'Mastodontes', laGoReplayPrompt: 'Rejouer en', laModeResume: 'Reprendre', laSpeed: 'Vitesse', laGoBigText: 'Gros texte',
    };
    var FB_EN = {
      ...
      laGoSubmit: 'Submit', laGoSubmitted: 'Submitted!', laGoNewRecord: 'New record!', laGoNewBadge: 'Record!',
      laGoThisRun: 'This run', laGoRecords: 'Records', laGoComboShort: 'Combo', laGoKillsShort: 'Enemies',
      ...
      laModeUnlockHint: 'Eliminate these enemies to unlock Hardcore mode', laEnemyScout: 'Scouts', laEnemyShooter: 'Shooters', laEnemyBruiser: 'Bruisers', laGoReplayPrompt: 'Play again in', laModeResume: 'Resume', laSpeed: 'Speed', laGoBigText: 'Large text',
    };
    var lang = 'fr';
    try {
