...
window.SITE_I18N = {
  fr: {
    ...
    laUpDroneDesc2:      '2 drones, qui foncent et se rechargent plus vite.',
    laUpDroneDesc3:      '3 drones ; leur explosion marque les ennemis touchés (synergie Détonation).',
  ...
  en: {
    ...
    laUpDroneDesc2:      '2 drones that dive and recharge faster.',
    laUpDroneDesc3:      '3 drones; their blast marks the enemies it hits (Detonation synergy).',
