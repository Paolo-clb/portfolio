...
window.SITE_I18N = {
  fr: {
    ...
    laUpDashAtkDesc1:    'Attaque plus grosse et plus rapide.',
    ...
    laUpDetonationDesc2: 'Le rayon de la détonation est 1.5× plus grand — et bien plus spectaculaire.',
    laUpDashName:        'Dash',
    laUpDashDesc1:       'Dash plus rapide, récupération plus courte.',
    ...
    laUpShieldDesc1:     '+1 emplacement de shield.',
    laUpShieldDesc2:     '+1 emplacement de shield supplémentaire.',
    laUpTheWorldName:    'The World',
    laUpTheWorldDesc1:   'Le clic molette arrête le temps pendant 3 secondes. (Cooldown : 30s)',
  ...
  en: {
    ...
    laUpDashAtkDesc1:    'Dash-Attack is bigger and faster.',
    ...
    laUpDashName:        'Dash',
    laUpDashDesc1:       'Faster dash, shorter cooldown.',
    ...
    laUpShield:          'Shield',
    laUpShieldName:      'Shield',
    laUpShieldDesc1:     '+1 shield slot.',
    laUpShieldDesc2:     '+1 additional shield slot.',
    laUpTheWorldName:    'The World',
    laUpTheWorldDesc1:   'Middle-click stops time for 3 seconds. (Cooldown: 30s)',
